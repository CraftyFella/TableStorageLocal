...
--batch_14ea6083-4fdb-4d9a-ad2a-81d43ac26f8d--"""
      ...
      test "delete request from sdk" {

        let http = """POST /devstoreaccount1/$batch HTTP/1.1
Host: localhost.charlesproxy.com:57282
Accept-Charset: UTF-8
MaxDataServiceVersion: 3.0;NetFx
Accept: application/json; odata=minimalmetadata
DataServiceVersion: 3.0;
x-ms-client-request-id: 68d766df-57ca-4461-bf0e-53606bcfb834
User-Agent: Azure-Cosmos-Table/1.0.8 (.NET CLR 3.1.8; Unix 19.6.0.0)
x-ms-version: 2017-07-29
x-ms-date: Wed, 21 Oct 2020 16:17:13 GMT
Authorization: SharedKey devstoreaccount1:XJSbVfJ2lD9+YDji/Th5GXoJ4OV68M3DEGhzLQ1wEDM=
Content-Type: multipart/mixed; boundary=batch_a3d38656-b376-4baa-98e0-14bc78bec47c
Content-Length: 611

--batch_a3d38656-b376-4baa-98e0-14bc78bec47c
Content-Type: multipart/mixed; boundary=changeset_4829c950-d7ad-4df7-9c7a-54870aed3d51

--changeset_4829c950-d7ad-4df7-9c7a-54870aed3d51
Content-Type: application/http
Content-Transfer-Encoding: binary

DELETE http://localhost.charlesproxy.com:57282/devstoreaccount1/test8(PartitionKey='pk2',RowKey='r2k') HTTP/1.1
Accept: application/json;odata=minimalmetadata
Content-Type: application/json
DataServiceVersion: 3.0;
If-Match: W/"datetime'2020-10-21T16:17:02.450Z'"
